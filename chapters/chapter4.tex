\chapter{Exploratory work: Usage scenarios and concept validation}

	In the first phase of the project, the main goal it to design the application ending up with a prototype and the users evaluation, to validate the features and their importance.
