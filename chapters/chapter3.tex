...
User-Centred Design is a development philosophy that positions usability as a primary goal rather than an afterthought. 
...
For that, there is two distinct structures to incorporate UCD into the Agile workflow, where the fist is referenced as \textit{one sprint ahead} and the other \textit{within iteration}.\cite{10795519}
...
As for the \textit{within iteration}, as the name implies, the design artefacts are developed in the same iteration they are produced.\cite{10795519}
