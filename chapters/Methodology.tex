...
For this project it was followed this guide and, besides that, it will follow a Model-View-Model (MVVM) pattern, where there is a clear separation between the logic and the UI, enabling a better development, testing and a clean code base.
...
The Figure \ref{fig:architecture} represents the project's architecture where is also possible to see some technologies that will be used, decided after the development of requirements.
