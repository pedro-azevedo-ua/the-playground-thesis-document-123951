...
In this project, requirements gathered during the second phase of UCD (SubSection \ref{subsec:ucd}) are documented as User Stories.
...
To help implement Scrum effectively, this project uses Jira as a project management tool\footnote{https://www.atlassian.com/software/jira}, enabling systematic planning, task assignment, and progress tracking in the development phase
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.15\textwidth]{figs/roadmap}
...
\subsubsection{Phase 1: Prototype and Feature Validation}
...
This phase starts applying both Scrum and ATDD methodologies (Sections \ref{sec:scrum} and \ref{sec:atdd})  to implement the most critical user stories identified from the first phase's feedback
